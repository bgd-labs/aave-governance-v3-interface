...
import BackArrow from '../../assets/icons/arrowToLeft.svg';
import NextArrow from '../../assets/icons/arrowToRight.svg';
...
import { TimelineContent } from '../ProposalsDetails/Timeline/TimelineContent';
              ...
              sx={{
                ...
                background:
                  theme.palette.mode === 'dark'
                    ? `url('/helpModals/${statusInfo.image}Dark.svg')`
                    : `url('/helpModals/${statusInfo.image}.svg')`,
