...
import { RepresentationsTableWrapper } from '../Representations/RepresentationsTableWrapper';
      ...
      <HelpModalContainer
                  ...
                  sx={{
                    ...
                    background:
                      theme.palette.mode === 'dark'
                        ? `url('/helpModals/representatives${
                            txSuccess
                              ? 'Done'
        ...
        {txPending && (
          <HelpTxWrapper
            ...
            txPending={txPending}
            txSuccess={txSuccess}
            txStartImageMobile="helpModals/txLoadingMobile.svg"
            txEndImageMobile="helpModals/txLoadingMobile.svg"
            withTxOnMobile
            txBlock={
