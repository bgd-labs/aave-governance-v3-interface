      ...
      <HelpModalContainer
        ...
        {!isVoteButtonClick ? (
          <>
                    ...
                    sx={{
                      ...
                      background:
                        theme.palette.mode === 'dark'
                          ? `url('/helpModals/proposalMainDark.svg')`
                          : `url('/helpModals/proposalMain.svg')`,
            ...
            <Box
              ...
              <Box
                ...
                <ActiveItem
                  proposalData={formatActiveProposalData({
                    ...
                    title: helpProposalData.metadata.title,
                  })}
                  voteButtonClick={() => setIsVoteButtonClick(true)}
                  isForHelpModal
                  userData={{
                    voted: {
                      proposalId: BigInt(helpProposalData.proposalData.id),
                      votedInfo: {
                        votedPower:
                          helpProposalData.votingData.votedInfo.votingPower,
                        support: helpProposalData.votingData.votedInfo.support,
                      },
                      isVoted:
                        helpProposalData.votingData.votedInfo.votingPower !==
                        0n,
                    },
                    voting: helpProposalData.balances,
                    votingPower: helpProposalData.balances
          ...
          <HelpTxWrapper
            ...
            txStartImage={
              theme.palette.mode === 'dark'
                ? 'helpModals/proposalTxStartDark.svg'
                : 'helpModals/proposalTxStart.svg'
            }
            txEndImage={
              support
                ? theme.palette.mode === 'dark'
                  ? 'helpModals/proposalTxVotedAgainstDark.svg'
                  : 'helpModals/proposalTxVotedAgainst.svg'
                : theme.palette.mode === 'dark'
                  ? 'helpModals/proposalTxVotedForDark.svg'
                  : 'helpModals/proposalTxVotedFor.svg'
            }
            txStartImageMobile={
              theme.palette.mode === 'dark'
                ? 'helpModals/proposalTxStartMobileDark.svg'
                : 'helpModals/proposalTxStartMobile.svg'
            }
            txEndImageMobile={
              support
                ? theme.palette.mode === 'dark'
            ...
            txBlock={
              <HelpVoteTx
                ...
                helpProposalData={helpProposalData}
              />
            }>
            <>
              <Box
