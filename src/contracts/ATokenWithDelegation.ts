...
export interface ATokenWithDelegationInterface extends utils.Interface {
  functions: {
...
export interface ATokenWithDelegation extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ATokenWithDelegationInterface;
