...
import type {
  ...
  IGovernanceDataHelperInterface,
} from "./IGovernanceDataHelper";
...
export class IGovernanceDataHelper__factory {
  static readonly abi = _abi;
  static createInterface(): IGovernanceDataHelperInterface {
    return new utils.Interface(_abi) as IGovernanceDataHelperInterface;
  }
  static connect(
    address: string,
